...
| # | 日期 | 版本 | 類型 | 影響檔案 | 說明 |
|---|------|------|------|----------|------|
| 150 | 2026-04-30 | v1.5.1 | style | `static/style.css` | 全面導入 Apple Design System：Action Blue、18px 圓角、膠囊按鈕、scale(0.95) 動效、毛玻璃 Header、SF Pro 排版質感 |
| 151 | 2026-04-30 | v1.5.1 | ui | `*.html` | 同步頁面版本號，調整佈局留白至 24px-32px，優化全站空間感 |
| 152 | 2026-04-30 | v1.5.1 | docs | `PRD.md`, `RELEASE_NOTES.md`, `AGENTS.md` | 同步更新版本號與設計重構紀錄 |
