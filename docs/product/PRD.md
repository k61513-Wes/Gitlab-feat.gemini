...
| 版本 | 日期 | 說明 |
|------|------|------|
| v1.2.1 | 2026-04-19 | Dashboard 功能：Issue 統計、Milestone 篩選、Priority/Assignee 分布卡、趨勢折線圖、Issue 表格（排序/過濾/Popup/MR 狀態）；多頁面架構（login/dashboard/issuearrange）；Token 狀態跨頁持久化（sessionStorage/localStorage） |
